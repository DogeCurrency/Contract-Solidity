...
/*
 TG : https://t.me/dogecurrencyportal
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x495FD4876ddEb834C1F01750E937DAC588d03f79; // owner address
...
contract DogeCurrency is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Currency";
    string private _symbol = "Doge Currency"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x495FD4876ddEb834C1F01750E937DAC588d03f79); // Marketing Address
    address payable public teamWalletAddress = payable(0x495FD4876ddEb834C1F01750E937DAC588d03f79); // Team Address
    ...
    uint256 public _liquidityShare = 1; // original 5
